...
<div class="sidebar-nav navbar-collapse">
    <ul class="nav" id="side-menu">
        ...
        <li >
            ...
            <ul class="nav nav-second-level">
                <li><a href="{{ url('report/purchase')}}" class=" hvr-bounce-to-right"> <i class="fa fa-line-chart nav_icon @{{activepurchasereport}}"></i>Pembelian</a></li>
                
                <li><a href="{{url('report/sale')}}" class=" hvr-bounce-to-right"><i class="fa fa-bar-chart nav_icon @{{activeitemreport}}"></i>Penjualan</a></li>
           </ul>
        </li>
         <li>
